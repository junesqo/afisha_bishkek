...
import 'package:bishkekevents/SignUp/ChildViews/signupform.dart';
import 'package:bishkekevents/SignUp/ChildViews/signupimages.dart';
import 'package:bishkekevents/SignUp/ChildViews/signupintroduce.dart';
...
class _SignUpWithMail extends State<SignUpMain> {
  ...
  List<String> _imageStringList = List<String>.generate(1, (i) => '');
                              ...
                              child: Padding(
                                ...
                                child: RaisedButton(
                                  ...
                                  onPressed: () {
                                    ...
                                    } else if (_pageController.page.toInt() ==
                                        1) {
                                      _moveToNextPage();
                                    } else if (_pageController.page.toInt() ==
                                        2) {
